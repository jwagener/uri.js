...
this.flattenParams(f,c+"[]",d)}else c!==""&&d.push([c,a]);return d};this.parse=function(a,c){var d,b,e;a==null&&(a="");c==null&&(c={});b=a.match(j);this.scheme=b[1];d=b[2];if(d!=null){d=d.match(i);e=d[1];if(e!=null)this.user=e.split(":")[0],this.password=e.split(":")[1];this.host=d[2];this.port=parseInt(d[3],10)||null}this.path=b[3];this.query=b[4];if(c.decodeQuery)this.query=this.decodeParams(this.query);this.fragment=b[5];if(c.decodeFragment)return this.fragment=this.decodeParams(this.fragment)};
this.parse(g,h);return this};
